...
//    ): Flow<Resource<MediaItemModel>>
    ...
    suspend fun getMediaDetail(documentId: String): Flow<Resource<MediaItemDto>>

    suspend fun getAllMediaDetails(): Flow<Resource<List<MediaItemDto>>>
}
...
//    }
    ...
    override suspend fun getMediaDetail(documentId: String): Flow<Resource<MediaItemDto>> =
        callbackFlow {
                firestore.collection(Constants.FIRE_STORE_COLLECTION_NAME).document(documentId)
                    .get()
                    .addOnSuccessListener { data ->
                        trySend(Resource.Success(data = data.toObject(MediaItemDto::class.java)))
                        close()
    ...
    override suspend fun getAllMediaDetails(): Flow<Resource<List<MediaItemDto>>> =
        callbackFlow {
